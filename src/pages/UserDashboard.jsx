...
import { faIdBadge, faEnvelope, faPhoneAlt, faMapMarkerAlt } from "@fortawesome/free-solid-svg-icons";
...
const UserDashboard = () => {
  ...
  return (
    <div className="container mt-5 mb-5 m" style={{ paddingBottom: "80px", paddingTop: "40px" }}>
      <h2
      ...
      >
        ...
        <p><FontAwesomeIcon icon={faEnvelope} className="me-2" /><strong>Email:</strong> {display(user.email)}</p>
        <p><FontAwesomeIcon icon={faMapMarkerAlt} className="me-2" /><strong>Adres:</strong> {display(user.address)}</p>
        <p><FontAwesomeIcon icon={faPhoneAlt} className="me-2" /><strong>Telefon:</strong> {display(user.phone)}</p>
      </div>
